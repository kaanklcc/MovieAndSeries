...
class OnTheAirAdapter(val mContext : Context, var seriesList : ArrayList<Result>) : RecyclerView.Adapter<OnTheAirAdapter.OnTheAirViewHolder>() {

    class OnTheAirViewHolder(val binding : MovieRecyclerRowBinding): RecyclerView.ViewHolder(binding.root)
    ...
    override fun onBindViewHolder(holder: OnTheAirViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action= SeriesListFragmentDirections.actionSeriesListFragmentToSeriesDetailFragment(series)
